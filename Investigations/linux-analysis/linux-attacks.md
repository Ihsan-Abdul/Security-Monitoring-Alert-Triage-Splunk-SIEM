...
The firewall and Windows brute force activity documented elsewhere in this project ran from January 8 through January 12. Root-level access on this Linux server followed the same pattern but continued for two additional days, from January 10 through January 14, using access the attacker had already established rather than a fresh brute force campaign against the firewall:
