...
- **Duration:** January 8 through January 12, 2024, five consecutive days of brute force activity against the firewall. Root-level activity on the Linux server, documented in the Linux analysis, continued for two additional days beyond what the firewall logs alone show.
